...
export class Params {
  static encode(message: Params, writer: Writer): void {
    ...
    writer.uint32(24);
    writer.uint64(message.max_wasm_code_size);
  }
  ...
  max_wasm_code_size: u64;

  constructor(
    code_upload_access: AccessConfig | null = null,
    instantiate_default_permission: AccessType = 0,
    max_wasm_code_size: u64 = 0
  ) {
    this.code_upload_access = code_upload_access;
    this.instantiate_default_permission = instantiate_default_permission;
    this.max_wasm_code_size = max_wasm_code_size;
  }
}
